...
export const COGNATE_RULES = [
  ...
  { id: 'cr_ina_ine', pattern: '-ina → -ine', explanation: 'Substantivos em -ina terminam em -ine; o E final é mudo: piscina → piscine ("pissín").' },
  { id: 'cr_eza_esse', pattern: '-eza/-essa → -esse', explanation: 'O -eza e o -essa viram -esse (som "éss"): tristeza → tristesse.' },
  { id: 'cr_es_ais', pattern: '-ês → -ais', explanation: 'Nacionalidades e línguas em -ês terminam em -ais (som "é"; feminino -aise): português → portugais.' },
  { id: 'cr_ano_ain', pattern: '-ano → -ain', explanation: 'Adjetivos em -ano terminam em -ain (nasal "ẽ"; feminino -aine): humano → humain.' },
  { id: 'cr_ao_on', pattern: '-ão → -on', explanation: 'Muitos substantivos em -ão terminam em -on (nasal "õ"): avião → avion.' },
  ...
  { id: 'cr_ema_eme', pattern: '-ema → -ème', explanation: 'Palavras em -ema terminam em -ème (som "ém", masculinas): problema → problème.' },
  { id: 'cr_orio_oire', pattern: '-ória/-ório → -oire', explanation: 'O -ória/-ório vira -oire (som "uar"): história → histoire.' },
  { id: 'cr_uzir_uire', pattern: '-uzir → -uire', explanation: 'Verbos em -uzir terminam em -uire (som "üír"): conduzir → conduire.' },
  { id: 'cr_lh_ill', pattern: 'lh → ill', explanation: 'O LH do português costuma virar ILL (ou IL no fim), com som de "i": orelha → oreille.' },
  ...
  { id: 'cr_eta_ette', pattern: '-eta/-ete → -ette', explanation: 'O -eta/-ete vira -ette (som "ét"): omelete → omelette.' },
];
...
export const SCENES = [
  ...
  { id: 'sc_lu_creche', name: 'Creche e CSA', icon: 'baby', description: 'Rotina, horários, falar com as educadoras, avisar faltas e o chèque-service (CSA).',
  ...
  { id: 'sc_lu_commune', name: 'Commune', icon: 'building', description: 'Declaração de chegada, certificado de residência, documentos e prazos.',
  ...
  { id: 'sc_lu_banco', name: 'Banco', icon: 'bank', description: 'Abrir conta, transferências e pagar contas. Aqui não existe boleto: paga-se a fatura por transferência, com a referência.',
  ...
  { id: 'sc_lu_entrevista', name: 'Entrevista de emprego', icon: 'briefcase', description: 'Apresentar-se, experiência, idiomas, tipo de contrato e disponibilidade.',
  ...
  { id: 'sc_lu_pediatra', name: 'Pediatra e médico de família', icon: 'health', description: 'Marcar consulta, explicar sintomas, vacinas, remédios e reembolso da CNS.',
  ...
  { id: 'sc_lu_mercado', name: 'Supermercado', icon: 'cart', description: 'Achar os produtos, perguntar preço e promoção, devolver garrafas e pagar.',
  ...
  { id: 'sc_lu_transporte', name: 'Transporte público', icon: 'pin', description: 'Ônibus, trem e tram (grátis no país), horários, atrasos e conexões.',
  ...
  { id: 'sc_lu_vizinhanca', name: 'Vizinhança e condomínio', icon: 'user', description: 'Conhecer os vizinhos, barulho, lixo reciclável, porão e condomínio.',
